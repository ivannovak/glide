...
```go
// Line 12
import "github.com/glide-cli/glide/v3/pkg/app"
...
- [ ] Zero `import "github.com/glide-cli/glide/v3/pkg/app"` in `cmd/` (except tests)
- [ ] Zero `import "github.com/glide-cli/glide/v3/pkg/app"` in `internal/cli/` production code
