...
func TestCheckForUpdate_OlderVersionAvailable(t *testing.T) {
	...
	release := Release{
		...
		Name:        "v0.9.0",
		PublishedAt: time.Now(),
		HTMLURL:     "https://github.com/ivannovak/glide/v2/releases/tag/v0.9.0",
	}
	...
	tests := []struct {
	...
	}{
		{
			...
			info: &UpdateInfo{
				...
				ReleaseURL:     "https://github.com/ivannovak/glide/v2/releases/tag/v2.0.0",
				PublishedAt:    time.Date(2025, 1, 1, 0, 0, 0, 0, time.UTC),
				DownloadURL:    "https://github.com/ivannovak/glide/v2/releases/download/v2.0.0/glide-darwin-arm64",
			},
			expected: []string{
