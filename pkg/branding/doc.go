...
//
//	go build -ldflags "\
//	    -X github.com/glide-cli/glide/v3/pkg/branding.CommandName=mycli \
//	    -X github.com/glide-cli/glide/v3/pkg/branding.ProjectName=MyProject \
//	    -X github.com/glide-cli/glide/v3/pkg/branding.ConfigFileName=.mycli.yml"
//
// # Available Variables
//
